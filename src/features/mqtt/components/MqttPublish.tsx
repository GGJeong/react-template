...
const MqttPublish: React.FC<Props> = ({
  ...
  <div className="m-panel">
    <div className="m-panel-header">
      <span className="icon">▶</span> 메시지 발행
    </div>
    <div className="m-pub-grid">
      <div className="m-field">
        ...
        <input
          value={pubTopic}
          onChange={(e) => onPubTopicChange(e.target.value)}
      ...
      <div className="m-field">
        ...
        <select
          value={qos}
          onChange={(e) => onQosChange(Number(e.target.value) as 0 | 1 | 2)}
          disabled={!isConnected}
        >
      ...
      <div className="m-field">
        ...
        <div style={{ display: 'flex', alignItems: 'center', height: 36 }}>
          ...
          />
          <label htmlFor="m-retain" style={{ marginLeft: 6, fontSize: 12, cursor: 'pointer' }}>
            ON
          </label>
        </div>
      </div>
